...
`Lmod-6.0.1.tar.bz2`_ at the time of writing.

.. code:: bash

    tar xfvj Lmod-6.0.1.tar.bz2 && cd Lmod-6.0.1
...
.. code:: bash
    ...
    export PATH=$HOME/lmod/6.0.1/libexec:$PATH
...
.. code:: bash
    ...
    source $HOME/lmod/6.0.1/init/bash
    export LMOD_CMD=$HOME/lmod/6.0.1/libexec/lmod
...
.. _Lmod-6.0.1.tar.bz2: http://sourceforge.net/projects/lmod/files/Lmod-6.0.1.tar.bz2/download
