...
version = '3.4.0'  # this is meant to reference the version of EasyBuild
# The full version, including alpha/beta/rc tags.
release = '20170910.01'  # this is meant to reference the version of the documentation itself
