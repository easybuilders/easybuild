...
version = '4.4.0'  # this is meant to reference the version of EasyBuild
# The full version, including alpha/beta/rc tags.
release = '20210602.0'  # this is meant to reference the version of the documentation itself
