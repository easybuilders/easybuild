...
version = '4.0.0.dev'  # this is meant to reference the version of EasyBuild
# The full version, including alpha/beta/rc tags.
release = '20190816.0'  # this is meant to reference the version of the documentation itself
