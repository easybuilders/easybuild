...
version = '3.3.1.dev0'  # this is meant to reference the version of EasyBuild
# The full version, including alpha/beta/rc tags.
release = '20170708.01'  # this is meant to reference the version of the documentation itself
