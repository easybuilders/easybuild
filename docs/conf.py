...
version = '3.0.0'  # this is meant to reference the version of EasyBuild
# The full version, including alpha/beta/rc tags.
release = '20161117.01'  # this is meant to reference the version of the documentation itself
