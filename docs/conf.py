...
version = '4.3.1'  # this is meant to reference the version of EasyBuild
# The full version, including alpha/beta/rc tags.
release = '20201029.0'  # this is meant to reference the version of the documentation itself
