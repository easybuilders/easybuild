...
version = '3.1.2'  # this is meant to reference the version of EasyBuild
# The full version, including alpha/beta/rc tags.
release = '20170320.01'  # this is meant to reference the version of the documentation itself
