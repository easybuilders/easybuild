...
version = '2.5.0dev'  # this is meant to reference the version of EasyBuild
# The full version, including alpha/beta/rc tags.
release = '20151209.01'  # this is meant to reference the version of the documentation itself
