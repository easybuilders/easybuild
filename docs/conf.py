...
project = 'EasyBuild'
copyright = '2012-2016, Ghent University, CC-BY-SA'

# The default replacements for |version| and |release|, also used in various
# other places throughout the built documents.
#
# The short X.Y version.
version = '2.9.0.dev0'  # this is meant to reference the version of EasyBuild
# The full version, including alpha/beta/rc tags.
release = '20160923.01'  # this is meant to reference the version of the documentation itself
