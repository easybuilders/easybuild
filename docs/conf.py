...
version = '1.16.0'  # this is meant to reference the version of EasyBuild
# The full version, including alpha/beta/rc tags.
release = '20141217.02'  # this is meant to reference the version of the documentation itself
