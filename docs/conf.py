...
version = '4.6.0'  # this is meant to reference the version of EasyBuild
# The full version, including alpha/beta/rc tags.
release = '20220708.0'  # this is meant to reference the version of the documentation itself
