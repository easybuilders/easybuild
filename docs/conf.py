...
version = '2.4.0'  # this is meant to reference the version of EasyBuild
# The full version, including alpha/beta/rc tags.
release = '20151110.01'  # this is meant to reference the version of the documentation itself
