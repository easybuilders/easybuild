...
version = '4.2.0'  # this is meant to reference the version of EasyBuild
# The full version, including alpha/beta/rc tags.
release = '20200414.0'  # this is meant to reference the version of the documentation itself
