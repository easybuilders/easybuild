...
version = '4.3.3'  # this is meant to reference the version of EasyBuild
# The full version, including alpha/beta/rc tags.
release = '20210223.0'  # this is meant to reference the version of the documentation itself
