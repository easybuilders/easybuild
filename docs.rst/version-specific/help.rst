...
``--subdir-user-modules=SUBDIR-USER-MODULES``                        Base path of user-specific modules relative to --envvar-user-modules                                                                                                                                                                                                             
...
``--from-pr=PR#``                                          Obtain easyconfigs from specified PR (type <class 'int'>)                                                                        
...
Option flag                                                                  Option description                                                                                                                                                                                                                                                              
=========================================================================    ================================================================================================================================================================================================================================================================================
``--accept-eula=ACCEPT-EULA``                                                Accept EULA for specified software (type comma-separated list; default: )                                                                                                                                                                                                       
